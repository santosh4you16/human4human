...
<input type="text" class="form-control" id="text" name="orphanname" placeholder="Enter Orphanage Name">
</div>
</div>
<div class="form-group">
...
<input type="text" class="form-control" id="text1" name="pass" placeholder="Enter Password">
</div>
</div>
<br>
<div class="form-group">
